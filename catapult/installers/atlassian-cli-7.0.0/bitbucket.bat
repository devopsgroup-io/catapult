...
rem   java -jar "%dirPath%"/lib/bitbucket-cli-7.0.0.jar --server https://my.examplegear.com --user automation --password automation %*

java -jar "%dirPath%"/lib/bitbucket-cli-7.0.0.jar %*
