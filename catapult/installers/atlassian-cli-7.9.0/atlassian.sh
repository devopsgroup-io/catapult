...
elif [ "$application" = "agile" ]; then
    callString="agile-cli-${cliVersion}.jar --server https://jira.examplegear.com --user $user --password $password"
...
elif [ "$application" = "tempo" ]; then
    callString="tempo-cli-${cliVersion}.jar --server https://jira.examplegear.com --user $user --password $password"
elif [ "$application" = "structure" ]; then
    callString="structure-cli-${cliVersion}.jar --server https://jira.examplegear.com --user $user --password $password"
...
elif [ "$application" = "trello" ]; then
    callString="trello-cli-${cliVersion}.jar --token xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx"
