...
rem - - - - - - - - - - - - - - - - - - - - START CUSTOMIZE FOR YOUR INSTALLATION !!!
if "%application%"=="confluence"  set string=confluence-cli-7.9.0.jar --server https://confluence.examplegear.com --user %user% --password %password%
if "%application%"=="jira"        set string=jira-cli-7.9.0.jar --server https://jira.examplegear.com --user %user% --password %password%
if "%application%"=="agile"       set string=agile-cli-7.9.0.jar --server https://jira.examplegear.com --user %user% --password %password%
if "%application%"=="servicedesk" set string=servicedesk-cli-7.9.0.jar --server https://jira.examplegear.com --user %user% --password %password%
if "%application%"=="tempo"       set string=tempo-cli-7.9.0.jar --server https://jira.examplegear.com --user %user% --password %password%
if "%application%"=="structure"   set string=structure-cli-7.9.0.jar --server https://jira.examplegear.com --user %user% --password %password%
if "%application%"=="bamboo"      set string=bamboo-cli-7.9.0.jar --server https://bamboo.examplegear.com --user %user% --password %password%
if "%application%"=="bitbucket"   set string=bitbucket-cli-7.9.0.jar --server https://bitbucket.examplegear.com --user %user% --password %password%
if "%application%"=="hipchat"     set string=hipchat-cli-7.9.0.jar --server https://hipchat.examplegear.com --token xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
if "%application%"=="trello"      set string=trello-cli-7.9.0.jar --token xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
if "%application%"=="upm"         set string=upm-cli-7.9.0.jar --server https://bitbucket.examplegear.com --user %user% --password %password%
if "%application%"=="csv"         set string=csv-cli-7.9.0.jar --server https://bitbucket.examplegear.com --user %user% --password %password%
if "%application%"=="all"         set string=all-cli-7.9.0.jar
rem - - - - - - - - - - - - - - - - - - - - - END CUSTOMIZE FOR YOUR INSTALLATION !!!
