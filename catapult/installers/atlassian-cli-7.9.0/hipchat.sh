...
# java -jar `dirname $0`/lib/hipchat-cli-7.9.0.jar --server http://my-server --autoWait --token X1Xt096Pb9wyEf3EOsKkhc91wJ4MYYP0FcRcDFrx "$@"

java -jar `dirname $0`/lib/hipchat-cli-7.9.0.jar "$@"
