...
rem   java -jar "%dirPath%"/lib/jira-cli-7.9.0.jar --server https://my.examplegear.com --user automation --password automation %*

java -jar "%dirPath%"/lib/jira-cli-7.9.0.jar %*
