...
/bin/echo -e "========================================================="
/bin/grep --extended-regexp --max-count=10 --regexp="\" 404 " /var/log/httpd/access_log
...
/bin/echo -e "================================================================================"
/bin/grep --extended-regexp --max-count=10 --regexp="(denied|failed|failure|invalid|limit|permission)" /var/log/httpd/*/error_log
