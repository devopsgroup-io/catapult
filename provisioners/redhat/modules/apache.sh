...
# php configuration
sudo cat /catapult/provisioners/redhat/installers/php/php.conf > /etc/httpd/conf.d/php.conf
# mpm configuration
sudo cat /catapult/provisioners/redhat/installers/php/00-mpm.conf > /etc/httpd/conf.modules.d/00-mpm.conf
